...
module.exports = {
	...
	icon: 'fa-cloud', // or icon: '/icons/128.png', to use a image.
	...
	footer: 'Made with ❤️ by <a href="https://hayasaka.moe" target="_blank" rel="noopener noreferrer">hayasaka.moe</a>.',
